...
abstract class AppLocalizations {
  ...
  ///
  /// In tr, this message translates to:
  /// **'Sayfa verisi yüklenirken hata oluştu'**
  String get quranPageDataError;

  /// No verses found text
  ///
  /// In tr, this message translates to:
  /// **'Ayet bulunamadı'**
  ...
  /// No bookmarks yet text
  ///
  /// In tr, this message translates to:
  /// **'Henüz ayıraç eklenmemiş'**
  String get noBookmarksYet;

  /// Return to books text
  ///
  /// In tr, this message translates to:
  /// **'Kitaplara Dön'**
