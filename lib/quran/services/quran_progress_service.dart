...
class QuranProgressService {
  ...
  Future<int> getCurrentPage() async {
    final prefs = await SharedPreferences.getInstance();
    final page = prefs.getInt(_currentPageKey) ?? 0;
    // Eğer sayfa 0'dan küçükse, 0'a düzelt ve kaydet
    if (page < 0) {
      print('QuranProgressService: Found invalid page $page, migrating to page 0');
      await prefs.setInt(_currentPageKey, 0);
      return 0;
    }
    return page;
  }
